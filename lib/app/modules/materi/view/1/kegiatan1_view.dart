...
class Kegiatan1View extends StatefulWidget {
  const Kegiatan1View({super.key});

  @override
  State<Kegiatan1View> createState() => _Kegiatan1ViewState();
}

class _Kegiatan1ViewState extends State<Kegiatan1View> {
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Spacer(),
                              const Text(
                                "Wah, kamu sudah menyelesaikan materi Mengenal Bangun Datar!",
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                  fontSize: 22,
                                  fontFamily: "Nunito",
...
class TextMateri extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: rootBundle.loadString("assets/md/materi_1/$mdFileName.md"),
