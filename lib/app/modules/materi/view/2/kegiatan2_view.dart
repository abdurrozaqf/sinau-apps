...
class Kegiatan2View extends StatefulWidget {
  const Kegiatan2View({super.key});

  @override
  State<Kegiatan2View> createState() => _Kegiatan2ViewState();
}

class _Kegiatan2ViewState extends State<Kegiatan2View> {
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Spacer(),
                              const Text(
                                "Wah, kamu sudah menyelesaikan materi Jenis dan Sifat Segiempat!",
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                  fontSize: 22,
                                  fontFamily: "Nunito",
...
class TextMateri extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: rootBundle.loadString("assets/md/materi_2/$mdFileName.md"),
