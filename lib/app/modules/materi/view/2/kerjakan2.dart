...
import '../../../../data/models/kerjakan/quiz_kerjakan2.dart';

class KerjakanView2 extends StatefulWidget {
  const KerjakanView2({super.key});

  @override
  State<KerjakanView2> createState() => _KerjakanView2();
}

class _KerjakanView2 extends State<KerjakanView2> {
  //define the datas
                ...
                isPassed
                    ...
                    : GestureDetector(
                        onTap: () {
                          ...
                          Get.toNamed("/contohkegiatan2view");
                        },
                        child: Container(
                          alignment: Alignment.center,
                          width: Get.width,
