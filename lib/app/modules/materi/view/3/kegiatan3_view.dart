...
class Kegiatan3View extends StatefulWidget {
  const Kegiatan3View({super.key});

  @override
  State<Kegiatan3View> createState() => _Kegiatan3ViewState();
}

class _Kegiatan3ViewState extends State<Kegiatan3View> {
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Spacer(),
                              const Text(
                                "Wah, kamu sudah menyelesaikan materi Keliling dan Luas Segiempat!",
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                  fontSize: 22,
                                  fontFamily: "Nunito",
...
class TextMateri extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: rootBundle.loadString("assets/md/materi_3/$mdFileName.md"),
