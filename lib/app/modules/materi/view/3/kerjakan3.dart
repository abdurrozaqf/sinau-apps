...
import '../../../../data/models/kerjakan/quiz_kerjakan3.dart';

class KerjakanView3 extends StatefulWidget {
  const KerjakanView3({super.key});

  @override
  State<KerjakanView3> createState() => _KerjakanView3();
}

class _KerjakanView3 extends State<KerjakanView3> {
  //define the datas
                ...
                isPassed
                    ...
                    : GestureDetector(
                        onTap: () {
                          ...
                          Get.toNamed("/contohkegiatan3view");
                        },
                        child: Container(
                          alignment: Alignment.center,
                          width: Get.width,
