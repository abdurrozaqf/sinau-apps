...
class Kegiatan4View extends StatefulWidget {
  const Kegiatan4View({super.key});

  @override
  State<Kegiatan4View> createState() => _Kegiatan4ViewState();
}

class _Kegiatan4ViewState extends State<Kegiatan4View> {
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Spacer(),
                              const Text(
                                "Wah, kamu sudah menyelesaikan materi Jenis dan Sifat Segitiga!",
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                  fontSize: 22,
                                  fontFamily: "Nunito",
...
class TextMateri extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: rootBundle.loadString("assets/md/materi_4/$mdFileName.md"),
          ...
          return Padding(
            ...
            child: Markdown(
              ...
              styleSheet: MarkdownStyleSheet(
                ...
                h3: const TextStyle(fontSize: 12),
