...
import '../../../../data/models/kerjakan/quiz_kerjakan4.dart';

class KerjakanView4 extends StatefulWidget {
  const KerjakanView4({super.key});

  @override
  State<KerjakanView4> createState() => _KerjakanView4();
}

class _KerjakanView4 extends State<KerjakanView4> {
  //define the datas
                ...
                isPassed
                    ...
                    : GestureDetector(
                        onTap: () {
                          ...
                          Get.toNamed("/contohkegiatan4view");
                        },
                        child: Container(
                          alignment: Alignment.center,
                          width: Get.width,
