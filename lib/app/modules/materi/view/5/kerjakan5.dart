...
import '../../../../data/models/kerjakan/quiz_kerjakan5.dart';

class KerjakanView5 extends StatefulWidget {
  const KerjakanView5({super.key});

  @override
  State<KerjakanView5> createState() => _KerjakanView5();
}

class _KerjakanView5 extends State<KerjakanView5> {
  //define the datas
                ...
                isPassed
                    ...
                    : GestureDetector(
                        onTap: () {
                          ...
                          Get.toNamed("/contohkegiatan5view");
                        },
                        child: Container(
                          alignment: Alignment.center,
                          width: Get.width,
