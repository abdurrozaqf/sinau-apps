...
import '../../../data/models/question_model_5.dart';

class QuizView5 extends StatefulWidget {
  const QuizView5({super.key});

  @override
  State<QuizView5> createState() => _QuizView5State();
}

class _QuizView5State extends State<QuizView5> {
  //define the datas
